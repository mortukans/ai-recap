...
const RECAP_SYSTEM = [
  ...
  'Action items must be EXHAUSTIVE: every task, to-do, intention, promise or "we need to / I have to" mentioned',
  'becomes its own item, including short, informal or personal ones; never merge several into one item',
  'and never drop one because it seems minor. Count them before answering.',
