...
**On the phone (TestFlight 0.0.1 (25) — uploaded 2026-09-22 12:14 UTC, CI run 35595986483: processing queue can no longer freeze (AI request timeouts, 25-min watchdog, Restart button on busy recaps). Daily cap lifted for testing.)**
...
## What to test on TestFlight 0.0.1 (25)
