...
**On the phone (TestFlight 0.0.1 (27) — uploaded 2026-09-22 14:07 UTC, CI run 35605800303: recording screen header fix (X discards the recording, context chip opens the picker) plus everything in 26: AI request timeouts, queue watchdog, Restart on busy recaps, and a Force-stop control (Home banner Stop/Resume, Settings row) that aborts the in-flight AI call and leaves the recap rerunnable. Daily cap lifted for testing.)**
...
## What to test on TestFlight 0.0.1 (27)
