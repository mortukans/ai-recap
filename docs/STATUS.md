...
**On the phone (TestFlight 0.0.1 (26) — uploaded 2026-09-22 13:14 UTC, CI run 35600330040: AI request timeouts, queue watchdog, Restart on busy recaps, and a Force-stop control (Home banner Stop/Resume, Settings row) that aborts the in-flight AI call and leaves the recap rerunnable. Daily cap lifted for testing.)**
...
## What to test on TestFlight 0.0.1 (26)
