...
**On the phone (TestFlight 0.0.1 (22) — uploaded 2026-09-21 22:12 UTC, CI run 35540024864: + 90-min recordings, per-recap model experiments with compare, app language setting. Daily cap lifted for testing.)**
...
## What to test on TestFlight 0.0.1 (22)
